...
$sql = "SELECT PId, Price ,ProductName ,CDate ,ModDate ,Deleted FROM Product";
...
if ($result->num_rows > 0) {
 ...
 echo "<tr bgcolor='lightblue'>"; echo "<th width='200px'>รหัสสินค้า"; echo "</th>";echo "<th> ราคา";echo "</th>"; echo "<th> ชื่อสินค้า"; echo "</th>";echo "<th> วันผลิต: ";echo "</th>";echo "<th> วันหมดอายุ: ";echo "</th>";echo "<th> วันที่ลบสินค้า: ";echo "</th>";
...
// output data of each row
 ...
 while($row = $result->fetch_assoc()) {
    ...
    echo "<td><a href='editproduct.php? PId=$row[PId]'>".$row["PId"]."</a></td>"."<td>".$row["Price"]."</td>"."<td>".$row["ProductName"]."</td>"."<td>".$row["CDate"]."</td>"."<td>".$row["ModDate"]."</td>"."<td>".$row["Deleted"]."</td>";
 ...
 echo "</tr>"."<br>";    
  ...
  echo "<a href='insertproduct.php'>กดเพื่อเพิ่มข้อมูลสินค้า</a>";
